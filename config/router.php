...
$router->addRoute("GET", "/dice", "\Magv20\Controller\dice");
$router->addRoute("POST", "/21_1", "\Magv20\Controller\dice_1");
$router->addRoute("POST", "/21_2", "\Magv20\Controller\dice_2");
...
$router->addGroup("/form", function (RouteCollector $router) {
    $router->addRoute("GET", "/view", ["\Magv20\Controller\Form", "view"]);
    $router->addRoute("POST", "/process", ["\Magv20\Controller\Form", "process"]);
});
